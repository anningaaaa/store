...
print("  27号     皮草         153.9         855                  57")
print("  28号     羽绒服       253.6         500                   10")
print("  29号     T恤         65.8          632                   63")
print("  30号     风衣        96.8           335                  78")
print("12月销售总金额：￥ ", (253.6 * 10 + 86.3 * 60 + 96.8 * 43 + 135.9 *
      63 + 65.8 * 63 + 49.3 * 120 + 86.3 * 72 + 253.6 * 69 +
      86.3 * 35 + 253.6 * 140 + 86.3*90 + 135.9 * 24 + 65.8 * 45 +
      96.8 * 25 + 86.3 * 60 + 65.8 * 129 + 253.6 * 10 + 96.8 * 43
      + 65.8 * 63 + 86.3 * 60 + 135.9 * 63 + 96.8 * 60 + 65.8 * 58
      + 86.3 * 140 + 65.8 * 48 + 96.8 * 43 + 153.9 * 57 + 253.6 * 10
      + 65.8 * 63 + 96.8 * 78))
print("羽绒服销售占比:", ((10+69+140+10+10)/1844)*100, "%")
print("皮草销售占比:", ((63+24+63+57)/1844)*100, "%")
print("牛仔裤销售占比:", ((60+72+35+90+60+60+140)/1844)*100, "%")
print("风衣销售占比:", ((43+25+43+60+43+78)/1844)*100, "%")
print("衬衫销售占比:", (120/1844)*100, "%")
print("T恤销售占比:", ((63+45+129+63+58+48+63)/1844)*100, "%")